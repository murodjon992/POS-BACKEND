...
urlpatterns = [
    ...
    path("owner-excel-upload/", owner_excel_upload), # Excel orqali mahsulot yuklash,
    ...
    path("debtor-sales/<int:customer_id>/",get_debtor_details), # Qarzdorlar malumtlari bilan
