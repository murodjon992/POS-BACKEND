...
def send_daily_reports():
    ...
    # Tip aralashmasligi uchun nol qiymatini Decimal tipida belgilaymiz
    ...
    for sub in active_subs:
        ...
        try:
            # ── 2. SEYF — hamma vaqtdagi real naqd pul ──────────────────────────
            ...
            # ── 3. KUNLIK SAVDO MANTIQI (RANGE BILAN - ENG XAVFSIZ YO'L) ───────
            # Celery-da __date ba'zan xato ishlashini oldini olish uchun kun boshlanishi va tugashini aniq belgilaymiz
            ...
            # ── 4. SUPPLIER (TA'MINOTCHILAR) QARZI ────────────────────────────────
            ...
            daily_supplier_return = SupplierLog.objects.filter(supplier__owner=actual_owner,type='return',created_at__range=(start_of_day,end_of_day)).aggregate(
                s=Coalesce(Sum('amount', output_filed=DecimalField()), decimal_zero))['s']
            ...
            # ── 6. KUNLIK CHIQIMLAR VA RO'YXATI ──────────────────────────────────
            ...
            if expense_qs.exists():
                ...
                for exp in expense_qs:
                    # 🌟 MANA BU JOYI TO'G'RILANDI: Bazadan kelgan UTC vaqtni O'zbekistonga o'giramiz!
            ...
            # ── TELEGRAM MATNINI SHAKLLANTIRISH ──────────────────────────────────
            msg = (
            ...
            # Telegramga HTML formatda yuborish
            res = requests.post(
                url, 
